...
@author: zoech
"""
# Use this code to produce a calibration factor based off of the slope produced by
    # plotting the scale reading and the TT reading of multiple weights. Divide
    # TT readings by this value to get the weight in grams.
...
plt.title('Known Weight vs. TT Weight to produce Calibration Factor')
plt.legend()
